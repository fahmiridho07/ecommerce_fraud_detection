...
const doc = new Document({
  ...
  sections:[{
    ...
    children:[
      ...
      p("Protokol evaluasi konsisten di seluruh kajian: stratified holdout 60/20/20, random_state 42, metrik utama PR-AUC (Average Precision), pemilihan threshold di validation (MCC), dan uji signifikansi paired bootstrap 2000 resample.",{italics:true,size:18}),
      ...
      cap("Tabel 1. Perbandingan 14 pendekatan AE-fitur terhadap baseline (full data, stratified)."),
      table,
